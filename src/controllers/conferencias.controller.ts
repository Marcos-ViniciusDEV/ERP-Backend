...
import * as conferenciaService from "../services/conferencia.service";
import {
 ...
 */
export async function listPendentes(_req: Request, res: Response) {
  try {
 ...
 */
export async function listByMovimentacao(req: Request, res: Response) {
  try {
...
export async function iniciar(req: Request, res: Response) {
  try {
    const movimentacaoId = parseInt(req.params.id);
    // Validar mas não usar o objeto retornado se não for necessário
    iniciarConferenciaSchema.parse({ movimentacaoEstoqueId: movimentacaoId });
...
export async function finalizar(req: Request, res: Response) {
  try {
    const movimentacaoId = parseInt(req.params.id);
    // Validar mas não usar o objeto retornado se não for necessário
    finalizarConferenciaSchema.parse({ movimentacaoEstoqueId: movimentacaoId });
 ...
 */
export async function getByCodigoBarras(req: Request, res: Response) {
  try {
 ...
 */
export async function deleteConferencia(req: Request, res: Response) {
  try {
    const conferenciaId = parseInt(req.params.id);
